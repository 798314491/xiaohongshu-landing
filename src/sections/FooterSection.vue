    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid md:grid-cols-4 gap-8">
        <div class="space-y-4">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-xl font-bold text-white">小红书去水印</span>
          </div>
          <p class="text-sm">
            专注于为用户提供最便捷的小红书内容下载体验
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>邮箱：qingmu0v0@outlook.com</li>
            <li>客服：9:00 - 21:00</li>
          </ul>
        </div>

        <div>
          <h3 class="text-lg font-semibold text-white mb-4">微信小程序</h3>
      ...
      <div class="border-t border-gray-800 mt-12 pt-8">
        <p class="text-center text-sm">
          © {{ new Date().getFullYear() }} 小红薯无水印图片下载. 保留所有权利.
          <span class="mx-2">|</span>
          <a href="#" class="hover:text-red-400 transition-colors">隐私政策</a>
          <span class="mx-2">|</span>
          <a href="#" class="hover:text-red-400 transition-colors">服务条款</a>
          <span class="mx-2">|</span>
          鄂ICP备2025089336号
        </p>
      </div>
